...
const Portfolio = () => {
  const projects = [
    {
      ...
      description:
        "Saravana Flora’s new website is a modern, user-friendly platform designed for flower enthusiasts to browse, order, and manage floral products effortlessly.",
    ...
    },
    {
      ...
      description:
        "MAS Impex Pvt Ltd’s new website is a sleek, professional platform that showcases their global import-export services, making it easy for partners to explore, connect, and collaborate with confidence.",
      technologies: [
        "React",
        "Tailwind CSS",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Designed and developed a modern, responsive website for G Capital Trading FZE, a UAE-based exporter, to strengthen their global presence and highlight their commitment to streamlining international trade.",
    ...
    },
    {
      ...
      title: "Soft Detroits",
      description:
        "Proudly designed and developed the official website for our first-ever startup, SoftDetroits Pvt Ltd — a bold step into the world of digital innovation and smart tech solutions.",
      technologies: ["React", "Tailwind CSS", "Node.js", "Express.js"],
      images: [sd1, sd2, sd3],
  ...
  const nextImage = (projectId) => {
    ...
    setCurrentImageIndices((prev) => ({
      ...prev,
      [projectId]:
        (prev[projectId] || 0) >= project.images.length - 1
          ? 0
          : (prev[projectId] || 0) + 1,
    }));
  };
  ...
  const ListViewImageSlider = ({ project }) => {
    ...
    return (
      ...
      >
        <AnimatePresence
          initial={false}
          custom={currentImageIndices[project.id]}
        >
          <motion.img
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto mt-4 text-lg leading-relaxed text-gray-600">
              A collection of my work showcasing my skills across various
              technologies.
            </p>
          </motion.div>
