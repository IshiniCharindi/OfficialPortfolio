            ...
            <section className="py-6 sm:py-10 lg:py-16 bg-gray-100">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="max-w-xl mx-auto mt-3 text-sm leading-relaxed text-gray-500 sm:text-base">
                    ...
                    {/* Contact Info Cards - Updated with better text handling */}
                    <div className="max-w-5xl mx-auto mt-8 sm:mt-12">
                        <div className="grid grid-cols-1 gap-4 px-4 text-center md:px-0 md:grid-cols-3 sm:gap-6">
                            ...
                            {/* Email Card - Updated with text overflow handling */}
                            <div className="overflow-hidden bg-white border rounded-lg sm:rounded-xl">
                                <div className="p-4 sm:p-6">
                                    <svg className="flex-shrink-0 w-8 h-8 mx-auto text-pink-700 sm:w-10 sm:h-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {/* Contact Form */}
                        <div className="mt-6 overflow-hidden bg-white border rounded-lg sm:rounded-xl sm:mt-8">
                            <div className="px-4 py-8 sm:px-6 sm:py-12">
                                <h3 className="text-xl font-semibold text-center text-gray-900 sm:text-2xl md:text-3xl">
                                    Send me a message
                                </h3>
                                ...
                                <form onSubmit={handleSubmit} className="mt-8 sm:mt-12">
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-x-5 sm:gap-y-4">
                                        <div>
                                            <label className="text-sm font-medium text-gray-900 sm:text-base">Your name</label>
                                        ...
                                        <div>
                                            <label className="text-sm font-medium text-gray-900 sm:text-base">Email address</label>
                                            <div className="mt-1.5 sm:mt-2.5 relative">
                                                <input
                                                    type="email"
                                                    placeholder="Enter your email"
                                                    className="block w-full px-3 py-3 text-sm text-black placeholder-gray-500 transition-all duration-200 bg-gray-50 border-2 border-gray-500 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600 sm:px-4 sm:py-3.5 sm:text-base"
                                                />
                                            </div>
                                        </div>

                                        <div>
                                            <label className="text-sm font-medium text-gray-900 sm:text-base">Phone number</label>
                                            <div className="mt-1.5 sm:mt-2.5 relative">
                                                <input
                                                    type="tel"
                                        ...
                                        <div>
                                            <label className="text-sm font-medium text-gray-900 sm:text-base">Company name</label>
                                            <div className="mt-1.5 sm:mt-2.5 relative">
                                                <input
                                                    type="text"
