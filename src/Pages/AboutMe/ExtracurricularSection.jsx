    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            I pursue passions beyond coding that shape me into a well-rounded
            ...
            <div className="inline-flex whitespace-nowrap animate-infinite-scroll items-center h-full">
              {duplicatedActivities.map((activity, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-6 h-6 -mt-2 rounded-full ${index % 2 === 0 ? "bg-pink-600" : "bg-indigo-600"} flex items-center justify-center`}
                    >
                      <motion.div
