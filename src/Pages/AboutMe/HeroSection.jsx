            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl relative z-10 py-16 md:py-20">
                <div className="grid items-center grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2">
                    ...
                    <div className="text-center md:text-left order-2 md:order-1">
                        <h2 className="text-2xl sm:text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl mb-1 sm:mb-2">
                            Hey, I am
                        </h2>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl text-black font-bold leading-tight mb-4 sm:mb-6">
                            Ishini Dewamiththa
                        </h1>
                        <h3 className="text-xl sm:text-2xl md:text-3xl text-pink-700 font-semibold mb-6 sm:mb-8">
                            Web Developer & Designer
                        </h3>
                        <p className="max-w-lg mx-auto md:mx-0 text-base sm:text-lg leading-relaxed text-gray-500 mb-8 sm:mb-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chat-left-text mr-2" viewBox="0 0 16 16">
                    ...
                    <div className="relative flex justify-center order-1 md:order-2 mb-8 md:mb-0">
                        <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
                            ...
                            />
                            <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-pink-600 text-white px-3 py-1 sm:px-4 sm:py-2 rounded-lg shadow-lg text-sm sm:text-base">
